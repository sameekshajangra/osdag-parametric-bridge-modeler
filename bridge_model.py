...
FOSSEE Summer Fellowship 2026 - Screening Task
"""
...
class OsdagBridgeModeler:
    ...
    def build_deck(self):
        ...
        for i in range(n_segments):
            # Segment box
            segment = Factory.create_rectangular_prism(seg_l, DECK_WIDTH, DECK_THICKNESS)
    ...
    def build_terrain(self):
        ...
        terrain = Factory.create_rectangular_prism(t_length, t_width, t_depth)
